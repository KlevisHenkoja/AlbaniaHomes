...
export default function Home() {
  const form = useRef();
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_8oi8zmr', 'template_hmji9he', form.current, 'v9UM2vFmhNbgJlPLH');
    ...
    <div className='bg-slate-600 '>
      ...
      <div className=" flex flex-col p-5 m-3 justify-between md:flex-row sm:flex-col ">
                <article className='bg-blue-950 w-56 p-5 my-0 rounded-xl text-center border-2 border-blue-950 mx-auto transition hover:bg-transparent hover:border-primary-variant'>
                    ...
                    <h5 className='text-white'>info@albaniahomes.co.uk</h5>
                    <a href="mailto:info@albaniahomes.co.uk" target="_blank" className='mt-3 inline-block text-[0.8rem] text-blue-400 font-semibold'>Send Email</a>
                </article>
                
                <article className='bg-blue-950 w-56 px-9 my-0 py-5 rounded-xl text-center border-2 border-blue-950 transition hover:bg-transparent hover:border-primary-variant mx-auto'>
